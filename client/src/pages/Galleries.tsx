    ...
    <LayoutWrapper currentPage="galerias">
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold mb-4">Galerias</h1>
        ...
        {isLoading ? (
          ...
          <Card>
            <CardContent className="py-16 text-center">
              ...
              <h3 className="text-2xl font-semibold mb-2">Nenhuma galeria disponível</h3>
              <p className="text-muted-foreground">
                Em breve teremos novos trabalhos para você explorar!
              </p>
            </CardContent>
          </Card>
        )}
