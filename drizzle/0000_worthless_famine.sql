...
CREATE TABLE `siteConfig` (
	...
	`paymentStripeEnabled` boolean NOT NULL DEFAULT true,
	`paymentBankTransferEnabled` boolean NOT NULL DEFAULT false,
	`paymentBankDetails` text,
	`paymentCashEnabled` boolean NOT NULL DEFAULT false,
	`paymentCashInstructions` text,
	`paymentPixEnabled` boolean NOT NULL DEFAULT false,
	`paymentPixKey` text,
	`paymentPagarmeEnabled` boolean NOT NULL DEFAULT false,
	`paymentPagarmeApiKey` text,
	`siteFont` varchar(50) DEFAULT 'inter',
...
CREATE INDEX `messages_tenantId_idx` ON `messages` (`tenantId`);--> statement-breakpoint
