// Templates padrão de email para serem inseridos quando o fotógrafo ativa o módulo
...
<div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;margin-top:20px;margin-bottom:20px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
  ...
  <div style="padding:30px;">
    <p style="font-size:18px;color:#333;line-height:1.6;">Olá <strong>{{nome}}</strong>,</p>
    <p style="font-size:16px;color:#555;line-height:1.6;">Hoje é um dia muito especial e queremos te desejar um feliz aniversário cheio de alegria, amor e momentos incríveis!</p>
    ...
    <div style="text-align:center;margin:30px 0;">
      <p style="font-size:16px;color:#764ba2;font-weight:600;">🎉 Que venham muitos mais anos de felicidade! 🎉</p>
    </div>
    <p style="font-size:16px;color:#555;">Com carinho,<br><strong>{{fotografo}}</strong></p>
  </div>
  <div style="background:#f8f9fa;padding:20px;text-align:center;border-top:1px solid #eee;">
    <p style="font-size:12px;color:#999;margin:0;">Enviado com ❤️ via FlowClik</p>
  </div>
</div>
</body>
</html>`,
  },
  {
    ...
    subject: "🔥 Promoção Exclusiva para Você, {{nome}}!",
...
<div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;margin-top:20px;margin-bottom:20px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
  ...
  <div style="padding:30px;">
    <p style="font-size:18px;color:#333;line-height:1.6;">Olá <strong>{{nome}}</strong>,</p>
    <p style="font-size:16px;color:#555;line-height:1.6;">Preparamos uma promoção exclusiva para você! Por tempo limitado, estamos oferecendo condições especiais nos nossos serviços fotográficos.</p>
    <div style="background:linear-gradient(135deg,#f093fb 0%,#f5576c 100%);border-radius:8px;padding:20px;text-align:center;margin:20px 0;">
      ...
      <p style="color:rgba(255,255,255,0.9);font-size:14px;margin:5px 0 0;">Entre em contato para saber mais!</p>
    </div>
    <p style="font-size:16px;color:#555;line-height:1.6;">Não perca essa oportunidade! Responda este email ou entre em contato para agendar sua sessão.</p>
...
<div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;margin-top:20px;margin-bottom:20px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
  ...
  <div style="padding:30px;">
    ...
    <div style="background:#f0f7ff;border-left:4px solid #4facfe;padding:15px 20px;margin:20px 0;border-radius:0 8px 8px 0;">
      ...
      <p style="font-size:14px;color:#555;margin:8px 0 0;">Confira os detalhes e entre em contato caso precise de alguma alteração.</p>
    </div>
    <p style="font-size:16px;color:#555;line-height:1.6;">Estamos ansiosos para esse dia! Qualquer dúvida, é só responder este email.</p>
...
<div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;margin-top:20px;margin-bottom:20px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
  ...
  <div style="padding:30px;">
    ...
    <p style="font-size:16px;color:#555;line-height:1.6;">Suas fotos estão sendo tratadas com muito carinho e em breve estarão disponíveis para você.</p>
    <div style="text-align:center;margin:30px 0;">
...
<div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;margin-top:20px;margin-bottom:20px;box-shadow:0 4px 6px rgba(0,0,0,0.1);">
  ...
  <div style="padding:30px;">
    <p style="font-size:18px;color:#333;line-height:1.6;">Olá <strong>{{nome}}</strong>,</p>
    <p style="font-size:16px;color:#555;line-height:1.6;">É com muita alegria que te damos as boas-vindas! Estamos muito felizes em ter você como nosso cliente.</p>
    ...
    <div style="background:#f0fdf4;border-left:4px solid #43e97b;padding:15px 20px;margin:20px 0;border-radius:0 8px 8px 0;">
      <p style="font-size:16px;color:#333;margin:0;font-weight:600;">O que você pode esperar:</p>
      <ul style="font-size:14px;color:#555;margin:8px 0 0;padding-left:20px;">
        ...
        <li>Galeria online exclusiva</li>
      </ul>
    </div>
